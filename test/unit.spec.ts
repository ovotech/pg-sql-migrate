...
describe('Unit test', () => {
  it('Should use streams to execute migrations', async () => {
    ...
    expect(pg.query).toHaveBeenNthCalledWith(4, 'INSERT INTO test1 VALUES ($1)', [
      '2018-12-31T11:12:39.672Z',
    ]);
    expect(pg.query).toHaveBeenNthCalledWith(
      5,
      'ALTER TABLE my_test ADD COLUMN additional_3 VARCHAR;\n',
    );
    expect(pg.query).toHaveBeenNthCalledWith(6, 'INSERT INTO test1 VALUES ($1)', [
      '2019-01-02T08:36:08.858Z',
    ]);
  });
  ...
  it('Should await migrate function to run streams', async () => {
    ...
    expect(pg.query).toHaveBeenNthCalledWith(4, 'INSERT INTO testing VALUES ($1)', [
      '2018-12-31T11:12:39.672Z',
    ]);
    expect(pg.query).toHaveBeenNthCalledWith(
      5,
    ...
    expect(pg.query).toHaveBeenNthCalledWith(6, 'INSERT INTO testing VALUES ($1)', [
      '2018-12-31T11:57:10.022Z',
    ]);
